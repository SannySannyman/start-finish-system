...
#define NTP_DELAY_RECEIVED_PACKET 1000
#define NTP_DIFFERENC_LONG_PACKET 49    //uart 2400
//#define NTP_DIFFERENC_LONG_PACKET 13  //uart 9600
...
void InitNetwork(void)
{
    ...
    CallBackWDT1 = CallBackNetworkCounter; 
...
//                        DEBUG_UART_UartPutString(uartBuff);
    ...
    if(result == OK)
    {
        ...
        msTimeDifference += NTP_DIFFERENC_LONG_PACKET; //add static diff time to send packet 
    }
